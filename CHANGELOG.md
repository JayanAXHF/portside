...
- fix cargo-binstall AGAIN

## [0.6.2](https://github.com/JayanAXHF/portside/compare/v0.6.1...v0.6.2) - 2026-08-29

### Fixed

- fix history charts with proper hour counts
...
- add a today's total flag for integration with stuff like tmux
- add session removal and posthumous sessions
